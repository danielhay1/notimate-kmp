...
- [ ] Define Mode and Automation models with one-active-Mode invariants.
...
- [ ] Add shared tests for classification, Mode invariants, agent policy routing, proposal lifecycle, and validation.
...
- [ ] Add monitored-source filtering and active-Mode lookup.
...
- [ ] Implement settings, monitored-source, Mode, and Automation source of truth.
...
- [ ] Build Today with processing state, active Mode, proposal queue, and recent outcomes.
...
## Phase 6: Modes And Automations

- [ ] Build active Mode switcher.
- [ ] Build Automations list for the selected Mode.
- [ ] Build Manage Modes and Mode Detail.
- [ ] Enforce exactly one active Mode and prevent deleting the only Mode.
